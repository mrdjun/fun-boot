...
@Setter
@ToString
public class AppGenTable extends BaseEntity {
     ...
     * 字段列表
     */
    private List<AppGenTableColumn> fieldList;
     ...
     * 主键信息
     */
    private AppGenTableColumn pkColumn;

    /**
     * 表列信息
     */
    @Valid
    private List<AppGenTableColumn> columns;
