...
import com.fun.common.utils.job.ScheduleUtils;
...
import com.fun.project.admin.monitor.mapper.JobMapper;
...
public class JobServiceImpl implements IJobService {
    ...
    public int insertJob(Job job) throws SchedulerException, TaskException {
        job.setCreateTime(TimestampUtil.getCurrentTimestamp13());
    ...
    public int updateJob(Job job) throws SchedulerException, TaskException {
        job.setUpdateTime(TimestampUtil.getCurrentTimestamp13());
