...
import com.fun.common.constant.PermissionConstants;
...
public class PermissionUtils {
    ...
    public static String getMsg(String permissionsStr) {
        String permission = org.apache.commons.lang3.StringUtils.substringBetween(permissionsStr, "[", "]");
        String msg = MessageUtils.message(PERMISSION, permission);
        if (org.apache.commons.lang3.StringUtils.endsWithIgnoreCase(permission, PermissionConstants.ADD_PERMISSION)) {
            msg = MessageUtils.message(CREATE_PERMISSION, permission);
        } else if (org.apache.commons.lang3.StringUtils.endsWithIgnoreCase(permission, PermissionConstants.EDIT_PERMISSION)) {
            msg = MessageUtils.message(UPDATE_PERMISSION, permission);
        } else if (org.apache.commons.lang3.StringUtils.endsWithIgnoreCase(permission, PermissionConstants.REMOVE_PERMISSION)) {
            msg = MessageUtils.message(DELETE_PERMISSION, permission);
        } else if (org.apache.commons.lang3.StringUtils.endsWithIgnoreCase(permission, PermissionConstants.EXPORT_PERMISSION)) {
